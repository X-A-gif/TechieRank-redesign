  ...
  return (
    <div className='flex justify-center items-center w-full mx-10 h-screen bg-cover bg-center bg-no-repeat' style={{backgroundImage: `url(${bg})`}}>
      <div className='w-full flex justify-end'> 
            <div className='flex px-4 py-8 bg-opacity-40 bg-cover bg-center bg-no-repeat ' >
              <img src={land} alt="" className='techie flex justify-center items-center ' />
        
            <div className='w-1/2 h-3/4 border-2  py-4'>
