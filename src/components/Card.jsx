...
const Card = () => {
  return (
    <div className='flex flex-col justify-center items-center md:flex-row bg-cover object-cover bg-no-repeat w-full space-y-4 md:space-y-0 md:space-x-14'>
      <div className='glass w-full rounded-xl overflow-hidden shadow-md text-white flex-1'>
        ...
        <h1 className='text-3xl my-5'>Works with Github</h1>
          ...
          <h1 className='text-3xl my-5'>Stack Overflow</h1>
            <p className=' text-lg mx-24 font-thin'>
